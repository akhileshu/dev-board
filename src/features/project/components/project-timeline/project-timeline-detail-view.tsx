...
type ProjectTimelineDetailViewProps = {
  className?: string;
  projectTimelineResult: Awaited<ReturnType<typeof projectTimelineActions.getById>>;
};
...
function RenderProjectTimeline({ projectTimeline }: RenderProjectTimelineProps) {
  return (
   <div>edit this component to display details of ProjectTimeline</div>
  );
}